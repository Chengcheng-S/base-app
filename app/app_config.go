...
import (
	...
	tokenfactorymodulev1 "loan/api/loan/tokenfactory/module"
	_ "loan/x/tokenfactory/module" // import for side-effects
	tokenfactorymoduletypes "loan/x/tokenfactory/types"
