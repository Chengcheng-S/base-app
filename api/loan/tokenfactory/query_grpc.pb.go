...
const (
	Query_Params_FullMethodName   = "/loan.tokenfactory.Query/Params"
	Query_Denom_FullMethodName    = "/loan.tokenfactory.Query/Denom"
	Query_DenomAll_FullMethodName = "/loan.tokenfactory.Query/DenomAll"
)
